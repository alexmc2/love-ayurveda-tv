        ...
        <div className="py-8 md:pt-12 md:pb-12 border-t border-gray-300">
          ...
          <div className="grid gap-20" data-aos-id-features-home>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div
                className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 p-8 sm:p-12 md:order-1"
                data-aos="fade-up"
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className=" text-3xl text-slate-400 mb-2 text-center ">
