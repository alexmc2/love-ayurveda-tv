      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div>
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
              ...
              >
                <div className="mb-4 pb-4 border-b border-gray-700">
                  <div className="h4 text-fuchsia-700 mb-1">Essential</div>
              ...
              >
                ...
                <div className="mb-4 pb-4 border-b border-gray-700">
                  <div className="h4 text-fuchsia-700 mb-1">Premium</div>
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-2xl md:text-3xl font-medium text-gray-400">
                      $
                    </span>
              ...
              >
                <div className="mb-4 pb-4 border-b border-gray-700">
                  <div className="h4 text-fuchsia-700 mb-1">Advanced</div>
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-2xl md:text-3xl font-medium text-gray-400">
                      $
                    </span>
            ...
            {/* Bottom infobox */}
            <div className="flex flex-col lg:flex-row justify-between items-center mt-12 lg:mt-6 lg:py-8 lg:border-t lg:border-b lg:border-gray-400">
